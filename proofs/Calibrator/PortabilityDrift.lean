...
theorem twoDemeIMEquilibriumDelta_strictAnti :
  ...
  have h_lt : 2 * a + 1 < 2 * b + 1 := by linarith
  exact one_div_lt_one_div_of_lt ha_pos h_lt
...
theorem expectedSqMeanPGSDiff_IMEquilibrium_strictAnti_M
  ...
  have hd : twoDemeIMEquilibriumDelta b < twoDemeIMEquilibriumDelta a :=
    twoDemeIMEquilibriumDelta_strictAnti ha hb hab
  nlinarith
