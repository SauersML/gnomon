...
/-- **WGS PGS captures more variance.**
    WGS captures both common and rare variants, giving a total R². -/
noncomputable def wgsR2 (r2_common r2_rare : ℝ) : ℝ :=
  r2_common + r2_rare
...
theorem wgs_within_pop_better
    ...
    r2_common < wgsR2 r2_common r2_rare := by
  unfold wgsR2
  linarith
