...
noncomputable def haplotypeTransportBias
  ...
  |haplotypePhasePredictionError freq_cis_target interaction_cis interaction_trans pred_cis pred_trans -
   haplotypePhasePredictionError freq_cis_source interaction_cis interaction_trans pred_cis pred_trans|
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_hap : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := by
    unfold haplotypeTransportBias haplotypePhasePredictionError
    simp
  rw [h_hap]
  exact mul_pos
