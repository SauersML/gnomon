...
frequencies differ. -/
noncomputable def haplotypeTransportBias (_freq_cis_source freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
    averagePhaseInteraction freq_cis_target interaction_cis interaction_trans|
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_inner : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans = 0 := by
    unfold haplotypePhasePredictionError; ring
  rw [dosagePhaseMisspecificationError_eq, h_inner]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_inner : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by
    unfold haplotypeTransportBias; simp
  rw [dosageTransportBias_eq, h_inner]
  exact mul_pos
