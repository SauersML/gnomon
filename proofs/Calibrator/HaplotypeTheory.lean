...
noncomputable def PhasePredictor.misspecificationError
  ...
  freq_cis * (interaction_cis - p.predCis) ^ 2 +
    (1 - freq_cis) * (interaction_trans - p.predTrans) ^ 2

noncomputable def PhasePredictor.transportBias
    (p : PhasePredictor) (freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
    (freq_cis_target * p.predCis + (1 - freq_cis_target) * p.predTrans)|

noncomputable def haplotypePredictor (interaction_cis interaction_trans : ℝ) : PhasePredictor where
  predCis := interaction_cis
  predTrans := interaction_trans
...
noncomputable def haplotypePhasePredictionError (freq_cis interaction_cis interaction_trans : ℝ) : ℝ :=
  (haplotypePredictor interaction_cis interaction_trans).misspecificationError freq_cis interaction_cis interaction_trans
...
noncomputable def haplotypeTransportBias (freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  (haplotypePredictor interaction_cis interaction_trans).transportBias freq_cis_target interaction_cis interaction_trans
...
theorem haplotypePhasePredictionError_eq_zero (freq_cis interaction_cis interaction_trans : ℝ) :
  ...
  dsimp [haplotypePhasePredictionError, PhasePredictor.misspecificationError, haplotypePredictor]
  ring
...
theorem haplotypeTransportBias_eq_zero (freq_cis_target interaction_cis interaction_trans : ℝ) :
  ...
  dsimp [haplotypeTransportBias, PhasePredictor.transportBias, haplotypePredictor, averagePhaseInteraction]
