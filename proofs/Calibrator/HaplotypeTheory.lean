...
theorem haplotypePhasePredictionError_zero (freq_cis interaction_cis interaction_trans : ℝ) :
...
theorem haplotypeTransportBias_zero (freq_cis_target interaction_cis interaction_trans : ℝ) :
