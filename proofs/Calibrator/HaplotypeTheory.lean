...
structural phase-misspecification error when predictions perfectly match true interactions. -/
...
theorem haplotypeTransportBias_perfect
  ...
  have h_eq : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
