...
/-- A perfect phase-aware predictor predicts exactly the true interactions. -/
def perfectPhasePredictor (interaction_cis interaction_trans : ℝ) : PhaseAwarePredictor :=
  { predict_cis := interaction_cis,
    predict_trans := interaction_trans }

/-- A phase-aware haplotype predictor that tracks cis/trans configuration has no
structural phase-misspecification error. -/
noncomputable def haplotypePhasePredictionError (freq_cis interaction_cis interaction_trans : ℝ) (m : PhaseAwarePredictor) : ℝ :=
  freq_cis * (interaction_cis - m.predict_cis) ^ 2 +
    (1 - freq_cis) * (interaction_trans - m.predict_trans) ^ 2

theorem haplotypePhasePredictionError_eq_zero (freq_cis interaction_cis interaction_trans : ℝ) :
    haplotypePhasePredictionError freq_cis interaction_cis interaction_trans (perfectPhasePredictor interaction_cis interaction_trans) = 0 := by
  unfold haplotypePhasePredictionError perfectPhasePredictor
  ring
...
frequencies differ. -/
noncomputable def haplotypeTransportBias (freq_cis_source freq_cis_target interaction_cis interaction_trans : ℝ) (m : PhaseAwarePredictor) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target m.predict_cis m.predict_trans|

theorem haplotypeTransportBias_eq_zero (freq_cis_source freq_cis_target interaction_cis interaction_trans : ℝ) :
    haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans (perfectPhasePredictor interaction_cis interaction_trans) = 0 := by
  unfold haplotypeTransportBias averagePhaseInteraction perfectPhasePredictor
  ring_nf
  exact abs_zero
...
theorem compound_het_not_captured_by_dosage
    ...
    haplotypePhasePredictionError freq_cis interaction_cis interaction_trans (perfectPhasePredictor interaction_cis interaction_trans) < dosagePhaseMisspecificationError freq_cis interaction_cis interaction_trans := by
...
theorem haplotype_pgs_at_least_snp
    ...
    haplotypePhasePredictionError freq_cis interaction_cis interaction_trans (perfectPhasePredictor interaction_cis interaction_trans) ≤
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans (perfectPhasePredictor interaction_cis interaction_trans) < dosageTransportBias
