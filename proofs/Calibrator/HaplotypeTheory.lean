...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis interaction_trans pred_interaction : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - pred_interaction|
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_target interaction_cis interaction_trans (averagePhaseInteraction freq_cis_target interaction_cis interaction_trans) < dosageTransportBias
      freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  rw [dosageTransportBias_eq]
  have h_hap : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans (averagePhaseInteraction freq_cis_target interaction_cis interaction_trans) = 0 := by
