...
noncomputable def haplotypeTransportBias
  ...
  |averagePhaseInteraction freq_cis_source interaction_cis interaction_trans -
    averagePhaseInteraction freq_cis_source pred_cis pred_trans|
...
theorem haplotypeTransportBias_eq_zero
  ...
  have h_inner_target : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
    averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := by ring
  have h_inner_source : averagePhaseInteraction freq_cis_source interaction_cis interaction_trans -
    averagePhaseInteraction freq_cis_source interaction_cis interaction_trans = 0 := by ring
  rw [h_inner_target, h_inner_source]
  have h_abs_zero : |(0 : ℝ)| = 0 := abs_zero
  rw [h_abs_zero, sub_zero]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  rw [haplotypeTransportBias_eq_zero, dosageTransportBias_eq]
  exact mul_pos
