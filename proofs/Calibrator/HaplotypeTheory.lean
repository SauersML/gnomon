...
@[simp]
theorem haplotypePhasePredictionError_eq_zero (_freq_cis _interaction_cis _interaction_trans : ℝ) :
...
@[simp]
theorem haplotypeTransportBias_eq_zero (_freq_cis_source _freq_cis_target _interaction_cis _interaction_trans : ℝ) :
