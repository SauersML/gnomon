...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_pred_cis : pred_cis = interaction_cis)
    (h_pred_trans : pred_trans = interaction_trans) :
    haplotypeTransportBias freq_cis_target interaction_cis interaction_trans pred_cis pred_trans < dosageTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans := by
