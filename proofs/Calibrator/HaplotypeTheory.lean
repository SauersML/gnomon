...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans predicted_cis predicted_trans = 0 := by
    ...
    rw [h_pred_cis, h_pred_trans]
    have h_sub_self : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := sub_self _
    rw [h_sub_self]
    exact abs_zero
  rw [h_zero]
  exact mul_pos
