...
theorem haplotypePhasePredictionError_eval
...
theorem haplotypeTransportBias_eval
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans = 0 := haplotypePhasePredictionError_eval _ _ _
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := haplotypeTransportBias_eval _ _ _ _
