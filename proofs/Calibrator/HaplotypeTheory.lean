...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_hap : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans = 0 := by
    unfold haplotypeTransportBias; have h_inner : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := sub_self _ ; rw [h_inner, abs_zero]
  rw [h_hap]
  exact mul_pos
