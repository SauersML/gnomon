...
/-- A phase-aware haplotype predictor that tracks cis/trans configuration avoids
structural phase-misspecification error when it accurately learns the separate effects. -/
