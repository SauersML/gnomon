...
noncomputable def haplotypePhasePredictionError
    (_freq_cis interaction_cis interaction_trans : ℝ) : ℝ :=
  _freq_cis * (interaction_cis - interaction_cis) ^ 2 +
    (1 - _freq_cis) * (interaction_trans - interaction_trans) ^ 2

theorem haplotypePhasePredictionError_eq_zero
    (_freq_cis interaction_cis interaction_trans : ℝ) :
    haplotypePhasePredictionError _freq_cis interaction_cis interaction_trans = 0 := by
...
noncomputable def haplotypeTransportBias
    (_freq_cis_source _freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction _freq_cis_target interaction_cis interaction_trans -
    averagePhaseInteraction _freq_cis_target interaction_cis interaction_trans|

theorem haplotypeTransportBias_eq_zero
    (_freq_cis_source _freq_cis_target interaction_cis interaction_trans : ℝ) :
    haplotypeTransportBias _freq_cis_source _freq_cis_target interaction_cis interaction_trans = 0 := by
  unfold haplotypeTransportBias
  have h_eq : averagePhaseInteraction _freq_cis_target interaction_cis interaction_trans -
    averagePhaseInteraction _freq_cis_target interaction_cis interaction_trans = 0 := sub_self _
  rw [h_eq, abs_zero]
