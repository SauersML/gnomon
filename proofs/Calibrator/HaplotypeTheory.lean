...
noncomputable def haplotypeTransportBias
    (_freq_cis_source freq_cis_target interaction_cis interaction_trans pred_interaction_cis pred_interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
...
theorem haplotypeTransportBias_eq_zero
  ...
  have h_inner : freq_cis_target * interaction_cis + (1 - freq_cis_target) * interaction_trans - (freq_cis_target * interaction_cis + (1 - freq_cis_target) * interaction_trans) = 0 := sub_self _
  rw [h_inner]
  exact abs_zero
