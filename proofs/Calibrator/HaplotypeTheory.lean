...
/-- A phase-aware haplotype predictor that can learn distinct effects
for cis and trans configurations. -/
structure HaplotypePredictor where
  pred_cis : ℝ
  pred_trans : ℝ

/-- A perfect phase-aware predictor recovers the true interactions. -/
def perfectHaplotypePredictor (interaction_cis interaction_trans : ℝ) : HaplotypePredictor :=
...
noncomputable def haplotypePhasePredictionError
    (freq_cis interaction_cis interaction_trans : ℝ) (pred : HaplotypePredictor) : ℝ :=
...
theorem haplotypePhasePredictionError_eq_zero
    ...
    haplotypePhasePredictionError freq_cis interaction_cis interaction_trans
      (perfectHaplotypePredictor interaction_cis interaction_trans) = 0 := by
  unfold haplotypePhasePredictionError perfectHaplotypePredictor
  ring
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis interaction_trans : ℝ) (pred : HaplotypePredictor) : ℝ :=
  |(freq_cis_target * interaction_cis + (1 - freq_cis_target) * interaction_trans) -
    (freq_cis_target * pred.pred_cis + (1 - freq_cis_target) * pred.pred_trans)|
...
theorem haplotypeTransportBias_eq_zero
    ...
    haplotypeTransportBias freq_cis_target interaction_cis interaction_trans
      (perfectHaplotypePredictor interaction_cis interaction_trans) = 0 := by
  unfold haplotypeTransportBias perfectHaplotypePredictor
  ring_nf
  exact abs_zero
...
theorem compound_het_not_captured_by_dosage
    ...
    haplotypePhasePredictionError freq_cis interaction_cis interaction_trans
      (perfectHaplotypePredictor interaction_cis interaction_trans) <
