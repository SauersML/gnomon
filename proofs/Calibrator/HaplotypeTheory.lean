...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_freq_shift : _freq_cis_source ≠ freq_cis_target)
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias _freq_cis_source freq_cis_target interaction_cis interaction_trans < dosageTransportBias
      _freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  rw [dosageTransportBias_eq]
  have h_hap : haplotypeTransportBias _freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by
