...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_hap_bias_zero : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by
    ...
    rw [h_sub_self]
    exact abs_zero
  rw [dosageTransportBias_eq, h_hap_bias_zero]
  exact mul_pos
