...
theorem haplotypeTransportBias_eq_zero
  ...
  have h_zero : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := sub_self _
  rw [h_zero]
  exact abs_zero
