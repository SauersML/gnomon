...
structural phase-misspecification error because it accurately estimates
the specific phase interaction. -/
...
frequencies differ, because it accurately preserves phase predictions. -/
