...
noncomputable def haplotypePhasePredictionError
    (freq_cis interaction_cis predicted_cis interaction_trans predicted_trans : ℝ) : ℝ :=
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis predicted_cis interaction_trans predicted_trans : ℝ) : ℝ :=
...
theorem compound_het_not_captured_by_dosage
    ...
    haplotypePhasePredictionError freq_cis interaction_cis predicted_cis interaction_trans predicted_trans < dosagePhaseMisspecificationError freq_cis interaction_cis interaction_trans := by
  have h_zero : haplotypePhasePredictionError freq_cis interaction_cis predicted_cis interaction_trans predicted_trans = 0 := by
...
theorem haplotype_pgs_at_least_snp
    ...
    (h_pred_cis : predicted_cis = interaction_cis)
    (h_pred_trans : predicted_trans = interaction_trans) :
    haplotypePhasePredictionError freq_cis interaction_cis predicted_cis interaction_trans predicted_trans ≤
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_pred_cis : predicted_cis = interaction_cis)
    (h_pred_trans : predicted_trans = interaction_trans) :
    haplotypeTransportBias freq_cis_target interaction_cis predicted_cis interaction_trans predicted_trans < dosageTransportBias
      freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis predicted_cis interaction_trans predicted_trans = 0 := by
    rw [h_pred_cis, h_pred_trans]
