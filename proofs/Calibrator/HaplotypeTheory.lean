...
noncomputable def haplotypePhasePredictionError
    (_freq_cis interaction_cis interaction_trans pred_cis pred_trans : ℝ) : ℝ :=
  _freq_cis * (interaction_cis - pred_cis) ^ 2 +
    (1 - _freq_cis) * (interaction_trans - pred_trans) ^ 2
...
noncomputable def haplotypeTransportBias
    (_freq_cis_source freq_cis_target interaction_cis interaction_trans pred_cis pred_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
