...
/-- When the haplotype model perfectly predicts the cis and trans interaction effects,
its structural phase-misspecification error is zero. -/
...
noncomputable def haplotypeTransportBias
    (_freq_cis_source freq_cis_target interaction_cis interaction_trans predicted_cis predicted_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
    averagePhaseInteraction freq_cis_target predicted_cis predicted_trans|

/-- When the haplotype model perfectly predicts the cis and trans interaction effects,
its structural transport bias is zero. -/
theorem haplotypeTransportBias_perfect
  ...
  have h_zero : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := by ring
  rw [h_zero, abs_zero]
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_perfect : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans interaction_cis interaction_trans = 0 := haplotypePhasePredictionError_perfect freq_cis interaction_cis interaction_trans
  rw [h_perfect]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_perfect : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := haplotypeTransportBias_perfect freq_cis_source freq_cis_target interaction_cis interaction_trans
  rw [h_perfect]
  exact mul_pos
