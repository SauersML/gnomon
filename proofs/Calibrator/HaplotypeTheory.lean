...
noncomputable def haplotypePhasePredictionError
  ...
  _freq_cis * (_interaction_cis - _interaction_cis) ^ 2 +
    (1 - _freq_cis) * (_interaction_trans - _interaction_trans) ^ 2
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_haplotype_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans = 0 := by
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_haplotype_zero : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by
