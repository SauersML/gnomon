...
noncomputable def haplotypePhasePredictionError
    (freq_cis interaction_cis_actual interaction_cis_pred interaction_trans_actual interaction_trans_pred : ℝ) : ℝ :=
  freq_cis * (interaction_cis_actual - interaction_cis_pred) ^ 2 +
    (1 - freq_cis) * (interaction_trans_actual - interaction_trans_pred) ^ 2

theorem haplotypePhasePredictionError_perfect
    (freq_cis interaction_cis interaction_trans : ℝ) :
    haplotypePhasePredictionError freq_cis interaction_cis interaction_cis interaction_trans interaction_trans = 0 := by
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis_actual interaction_cis_pred interaction_trans_actual interaction_trans_pred : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis_actual interaction_trans_actual -
...
theorem haplotypeTransportBias_perfect
    ...
    haplotypeTransportBias freq_cis_target interaction_cis interaction_cis interaction_trans interaction_trans = 0 := by
