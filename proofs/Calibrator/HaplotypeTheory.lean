...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis_source interaction_cis_target interaction_trans_source interaction_trans_target : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis_target interaction_trans_target -
    averagePhaseInteraction freq_cis_target interaction_cis_source interaction_trans_source|
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans)
    (interaction_cis_source interaction_trans_source : ℝ)
    (h_port_cis : interaction_cis_source = interaction_cis)
    (h_port_trans : interaction_trans_source = interaction_trans) :
    haplotypeTransportBias freq_cis_target interaction_cis_source interaction_cis interaction_trans_source interaction_trans < dosageTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  rw [dosageTransportBias_eq]
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis_source interaction_cis interaction_trans_source interaction_trans = 0 := by
    rw [h_port_cis, h_port_trans]
