...
noncomputable def haplotypePhasePredictionError
    (freq_cis interaction_cis interaction_trans pred_interaction_cis pred_interaction_trans : ℝ) : ℝ :=
  freq_cis * (interaction_cis - pred_interaction_cis) ^ 2 + (1 - freq_cis) * (interaction_trans - pred_interaction_trans) ^ 2
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans interaction_cis interaction_trans = 0 := by { unfold haplotypePhasePredictionError; ring }
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := by { unfold haplotypeTransportBias averagePhaseInteraction; ring_nf; exact abs_zero }
