...
noncomputable def haplotypePhasePredictionError (predicted_cis predicted_trans interaction_cis interaction_trans freq_cis : ℝ) : ℝ :=
  freq_cis * (interaction_cis - predicted_cis) ^ 2 + (1 - freq_cis) * (interaction_trans - predicted_trans) ^ 2

theorem haplotypePhasePredictionError_eq_zero (freq_cis interaction_cis interaction_trans : ℝ) :
    haplotypePhasePredictionError interaction_cis interaction_trans interaction_cis interaction_trans freq_cis = 0 := by
...
frequencies differ. -/
noncomputable def haplotypeTransportBias (freq_cis_target predicted_cis predicted_trans interaction_cis interaction_trans : ℝ) : ℝ :=
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_zero : haplotypePhasePredictionError interaction_cis interaction_trans interaction_cis interaction_trans freq_cis = 0 := by
    exact haplotypePhasePredictionError_eq_zero freq_cis interaction_cis interaction_trans
  rw [h_zero]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := by
    exact haplotypeTransportBias_eq_zero freq_cis_target interaction_cis interaction_trans
  rw [h_zero]
  exact mul_pos
