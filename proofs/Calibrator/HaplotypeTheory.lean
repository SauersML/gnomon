...
noncomputable def haplotypePhasePredictionError
    (freq_cis pred_interaction_cis interaction_cis pred_interaction_trans interaction_trans : ℝ) : ℝ :=
  freq_cis * (pred_interaction_cis - interaction_cis) ^ 2 +
    (1 - freq_cis) * (pred_interaction_trans - interaction_trans) ^ 2
...
noncomputable def haplotypeTransportBias
    (freq_cis_target pred_interaction_cis interaction_cis pred_interaction_trans interaction_trans : ℝ) : ℝ :=
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_hap : haplotypePhasePredictionError freq_cis interaction_cis interaction_cis interaction_trans interaction_trans = 0 := by
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_target interaction_cis interaction_cis interaction_trans interaction_trans < dosageTransportBias
      freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  have h_hap : haplotypeTransportBias freq_cis_target interaction_cis interaction_cis interaction_trans interaction_trans = 0 := by
