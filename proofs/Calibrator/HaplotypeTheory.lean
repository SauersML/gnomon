...
noncomputable def haplotypeTransportBias
    (freq_cis_target freq_cis_source effect_target_cis effect_target_trans effect_source_cis effect_source_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target effect_target_cis effect_target_trans -
    averagePhaseInteraction freq_cis_target effect_source_cis effect_source_trans|
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans predicted_cis predicted_trans = 0 := by
...
theorem haplotype_pgs_more_portable_for_cis
    (freq_cis_source freq_cis_target interaction_cis interaction_trans effect_source_cis effect_source_trans effect_target_cis effect_target_trans : ℝ)
    (h_source_cis : effect_source_cis = interaction_cis)
    (h_source_trans : effect_source_trans = interaction_trans)
    (h_target_cis : effect_target_cis = interaction_cis)
    (h_target_trans : effect_target_trans = interaction_trans)
    (h_freq_shift : freq_cis_source ≠ freq_cis_target)
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_target freq_cis_source effect_target_cis effect_target_trans effect_source_cis effect_source_trans < dosageTransportBias
      freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  have h_zero : haplotypeTransportBias freq_cis_target freq_cis_source effect_target_cis effect_target_trans effect_source_cis effect_source_trans = 0 := by
    rw [h_source_cis, h_source_trans, h_target_cis, h_target_trans]
