...
/-- Structural transport bias when applying arbitrary phase predictions to a target population. -/
...
/-- A phase-aware haplotype predictor has exactly zero structural phase-misspecification error. -/
...
noncomputable def haplotypeTransportBias
  ...
  phaseTransportBias freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans

/-- A phase-aware haplotype model has exactly zero transport bias under portable phase effects. -/
theorem haplotypeTransportBias_eq_zero
  ...
  have h_diff : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
