...
structural phase-misspecification error when predicted effects perfectly match the true effects. -/
...
theorem haplotypePhasePredictionError_perfect_match
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis_source interaction_trans_source interaction_cis_target interaction_trans_target : ℝ) : ℝ :=
...
theorem haplotypeTransportBias_portable_effects
  ...
  have h_cis : |interaction_cis - interaction_cis| = 0 := by ring_nf; exact abs_zero
  have h_trans : |interaction_trans - interaction_trans| = 0 := by ring_nf; exact abs_zero
  rw [h_cis, h_trans]
  ring
...
theorem compound_het_not_captured_by_dosage
  ...
  rw [dosagePhaseMisspecificationError_eq, haplotypePhasePredictionError_perfect_match]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  rw [dosageTransportBias_eq, haplotypeTransportBias_portable_effects]
  exact mul_pos
