...
noncomputable def haplotypePhasePredictionError (freq_cis actual_cis actual_trans predicted_cis predicted_trans : ℝ) : ℝ :=
  freq_cis * (actual_cis - predicted_cis) ^ 2 + (1 - freq_cis) * (actual_trans - predicted_trans) ^ 2
...
frequencies differ. -/
noncomputable def haplotypeTransportBias (freq_cis_target actual_cis actual_trans predicted_cis predicted_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target actual_cis actual_trans - averagePhaseInteraction freq_cis_target predicted_cis predicted_trans|
