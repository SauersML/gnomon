...
structural phase-misspecification error when predictions perfectly match the true interactions. -/
...
the cis/trans effects themselves are portable and predictions match true effects. -/
