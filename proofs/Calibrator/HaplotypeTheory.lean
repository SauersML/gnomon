...
noncomputable def haplotypePhasePredictionError
    (freq_cis pred_interaction_cis pred_interaction_trans interaction_cis interaction_trans : ℝ) : ℝ :=
...
noncomputable def haplotypeTransportBias
    (freq_cis_target pred_interaction_cis pred_interaction_trans interaction_cis interaction_trans : ℝ) : ℝ :=
  freq_cis_target * |pred_interaction_cis - interaction_cis| +
    (1 - freq_cis_target) * |pred_interaction_trans - interaction_trans|
