...
structural phase-misspecification error because it accurately predicts the interaction
effect for both cis and trans carriers. -/
...
/-- A phase-aware haplotype model transports without structural bias because it applies
the correct source-learned cis and trans effects directly to the corresponding targets. -/
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_hap : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans = 0 := by
