...
theorem haplotypeTransportBias_eq_zero
  ...
  have h1 : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := sub_self _
  rw [h1]
  exact abs_zero
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans = 0 :=
    haplotypeTransportBias_eq_zero freq_cis_source freq_cis_target interaction_cis interaction_trans
