...
noncomputable def haplotypePhasePredictionError (pred_cis pred_trans : ℝ) (freq_cis interaction_cis interaction_trans : ℝ) : ℝ :=
  freq_cis * (interaction_cis - pred_cis) ^ 2 + (1 - freq_cis) * (interaction_trans - pred_trans) ^ 2
...
frequencies differ. -/
noncomputable def haplotypeTransportBias (pred_cis pred_trans : ℝ) (freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_haplotypePhasePredictionError_zero : haplotypePhasePredictionError interaction_cis interaction_trans freq_cis interaction_cis interaction_trans = 0 := by
    unfold haplotypePhasePredictionError
    ring_nf
  rw [dosagePhaseMisspecificationError_eq, h_haplotypePhasePredictionError_zero]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_haplotypeTransportBias_zero : haplotypeTransportBias interaction_cis interaction_trans freq_cis_target interaction_cis interaction_trans = 0 := by
    ...
    rw [h_inner]
    exact abs_zero
  rw [dosageTransportBias_eq, h_haplotypeTransportBias_zero]
  exact mul_pos
