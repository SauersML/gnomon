...
theorem compound_het_not_captured_by_dosage
  ...
  have h_hap_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans predicted_cis predicted_trans = 0 := by
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_hap_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans predicted_cis predicted_trans = 0 := by
    rw [h_pred_cis, h_pred_trans]
