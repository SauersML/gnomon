...
frequencies differ. -/
noncomputable def haplotypeTransportBias (interaction_cis interaction_trans : ℝ) : ℝ :=
  |interaction_cis - interaction_cis| + |interaction_trans - interaction_trans|

theorem haplotypeTransportBias_eq_zero (interaction_cis interaction_trans : ℝ) :
    haplotypeTransportBias interaction_cis interaction_trans = 0 := by
  ...
  rw [h1, h2, abs_zero, abs_zero, add_zero]
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias interaction_cis interaction_trans < dosageTransportBias
