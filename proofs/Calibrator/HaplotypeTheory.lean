...
noncomputable def haplotypePhasePredictionError
    (freq_cis risk_cis_actual risk_trans_actual risk_cis_pred risk_trans_pred : ℝ) : ℝ :=
  freq_cis * (risk_cis_actual - risk_cis_pred) ^ 2 +
    (1 - freq_cis) * (risk_trans_actual - risk_trans_pred) ^ 2
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis_actual interaction_trans_actual : ℝ)
    (_freq_cis_source interaction_cis_pred interaction_trans_pred : ℝ) : ℝ :=
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_target interaction_cis interaction_trans freq_cis_source interaction_cis interaction_trans <
      dosageTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  rw [dosageTransportBias_eq]
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans freq_cis_source interaction_cis interaction_trans = 0 := by
