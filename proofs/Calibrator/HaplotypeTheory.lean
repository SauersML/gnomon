...
structural phase-misspecification error when predictions perfectly match the interactions. -/
...
frequencies differ. -/
noncomputable def haplotypeTransportBias (interaction_cis_target interaction_cis_source interaction_trans_target interaction_trans_source : ℝ) : ℝ :=
  |interaction_cis_target - interaction_cis_source| + |interaction_trans_target - interaction_trans_source|
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias interaction_cis interaction_cis interaction_trans interaction_trans < dosageTransportBias
      freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  have h_zero : haplotypeTransportBias interaction_cis interaction_cis interaction_trans interaction_trans = 0 := by
