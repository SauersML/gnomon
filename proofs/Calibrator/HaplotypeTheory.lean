...
/-- When the haplotype predictions exactly match the true interactions, the error is zero. -/
...
/-- When the haplotype predictions perfectly match the interactions, the transport bias is zero. -/
