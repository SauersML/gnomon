...
/-- A general phase prediction error. -/
...
noncomputable def haplotypePhasePredictionError (freq_cis interaction_cis interaction_trans : ℝ) : ℝ :=
  phasePredictionError freq_cis interaction_cis interaction_trans interaction_cis interaction_trans
...
theorem haplotypePhasePredictionError_eq_zero
  ...
  unfold haplotypePhasePredictionError phasePredictionError
  ring

noncomputable def transportBias
    (freq_cis_target freq_cis_source
     actual_cis_target actual_trans_target
     predicted_cis predicted_trans : ℝ) : ℝ :=
  |phasePredictionError freq_cis_target actual_cis_target actual_trans_target predicted_cis predicted_trans -
   phasePredictionError freq_cis_source actual_cis_target actual_trans_target predicted_cis predicted_trans|
...
noncomputable def haplotypeTransportBias (freq_cis_source freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  transportBias freq_cis_target freq_cis_source interaction_cis interaction_trans interaction_cis interaction_trans
...
theorem haplotypeTransportBias_eq_zero
  ...
  unfold haplotypeTransportBias transportBias phasePredictionError
  have h_inner : freq_cis_target * (interaction_cis - interaction_cis) ^ 2 +
      (1 - freq_cis_target) * (interaction_trans - interaction_trans) ^ 2 -
      (freq_cis_source * (interaction_cis - interaction_cis) ^ 2 +
        (1 - freq_cis_source) * (interaction_trans - interaction_trans) ^ 2) = 0 := by
    ring
  rw [h_inner]
  exact abs_zero
