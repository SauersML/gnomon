...
theorem compound_het_not_captured_by_dosage
  ...
  have h_inner : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans = 0 := by unfold haplotypePhasePredictionError; ring
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_inner : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by unfold haplotypeTransportBias; rw [sub_self, abs_zero]
