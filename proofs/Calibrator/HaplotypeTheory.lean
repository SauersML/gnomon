...
noncomputable def haplotypePhasePredictionError
    (freq_cis prediction_cis prediction_trans interaction_cis interaction_trans : ℝ) : ℝ :=
...
noncomputable def haplotypeTransportBias
    (freq_cis_target prediction_cis prediction_trans interaction_cis interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
...
theorem compound_het_not_captured_by_dosage
    ...
    haplotypePhasePredictionError freq_cis prediction_cis prediction_trans interaction_cis interaction_trans <
  ...
  have h_zero : haplotypePhasePredictionError freq_cis prediction_cis prediction_trans interaction_cis interaction_trans = 0 := by
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_target prediction_cis prediction_trans interaction_cis interaction_trans <
      dosageTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  rw [dosageTransportBias_eq]
  have h_zero : haplotypeTransportBias freq_cis_target prediction_cis prediction_trans interaction_cis interaction_trans = 0 := by
    rw [h_pred_cis, h_pred_trans]
