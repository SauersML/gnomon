...
theorem haplotypeTransportBias_eq_zero
  ...
  have h : averagePhaseInteraction freq_cis_target interaction_cis interaction_trans - averagePhaseInteraction freq_cis_target interaction_cis interaction_trans = 0 := by ring
  exact (abs_eq_zero).mpr h
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans interaction_cis interaction_trans = 0 := haplotypePhasePredictionError_eq_zero _ _ _
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := haplotypeTransportBias_eq_zero _ _ _
