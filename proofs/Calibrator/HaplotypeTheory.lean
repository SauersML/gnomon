...
noncomputable def haplotypePhasePredictionError
    (freq_cis interaction_cis_pred interaction_trans_pred interaction_cis_true interaction_trans_true : ℝ) : ℝ :=
  freq_cis * (interaction_cis_true - interaction_cis_pred) ^ 2 +
    (1 - freq_cis) * (interaction_trans_true - interaction_trans_pred) ^ 2
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis_pred interaction_trans_pred interaction_cis_true interaction_trans_true : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis_true interaction_trans_true -
    averagePhaseInteraction freq_cis_target interaction_cis_pred interaction_trans_pred|
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_hap_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans interaction_cis interaction_trans = 0 := by
    unfold haplotypePhasePredictionError
    have h_sub_cis : interaction_cis - interaction_cis = 0 := sub_self _
    have h_sub_trans : interaction_trans - interaction_trans = 0 := sub_self _
    rw [h_sub_cis, h_sub_trans]
    ring
  rw [dosagePhaseMisspecificationError_eq, h_hap_zero]
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_bias_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := by
    ...
    rw [h_sub, abs_zero]
  rw [dosageTransportBias_eq, h_bias_zero]
  exact mul_pos
