...
def idealPhasePredictor (interaction_cis interaction_trans : ℝ) : PhasePredictor :=
...
theorem haplotypePhasePredictionError_eq
    ...
    haplotypePhasePredictionError (idealPhasePredictor interaction_cis interaction_trans) freq_cis interaction_cis interaction_trans = 0 := by
  dsimp [haplotypePhasePredictionError, idealPhasePredictor]
  ring
...
/-- A phase-aware haplotype model transports bias. -/
noncomputable def haplotypeTransportBias
    (pred : PhasePredictor) (freq_cis_source freq_cis_target interaction_cis interaction_trans : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
    averagePhaseInteraction freq_cis_source interaction_cis interaction_trans -
    (averagePhaseInteraction freq_cis_target pred.pred_cis pred.pred_trans -
      averagePhaseInteraction freq_cis_source pred.pred_cis pred.pred_trans)|

theorem haplotypeTransportBias_eq
    (freq_cis_source freq_cis_target interaction_cis interaction_trans : ℝ) :
    haplotypeTransportBias (idealPhasePredictor interaction_cis interaction_trans) freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by
  dsimp [haplotypeTransportBias, idealPhasePredictor]
  ring_nf
  exact abs_zero
...
theorem compound_het_not_captured_by_dosage
    ...
    haplotypePhasePredictionError (idealPhasePredictor interaction_cis interaction_trans) freq_cis interaction_cis interaction_trans < dosagePhaseMisspecificationError freq_cis interaction_cis interaction_trans := by
...
theorem haplotype_pgs_at_least_snp
    ...
    haplotypePhasePredictionError (idealPhasePredictor interaction_cis interaction_trans) freq_cis interaction_cis interaction_trans ≤
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias (idealPhasePredictor interaction_cis interaction_trans) freq_cis_source freq_cis_target interaction_cis interaction_trans < dosageTransportBias
