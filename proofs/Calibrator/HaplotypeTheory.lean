...
structural phase-misspecification error because it predicts the exact interaction
...
frequencies differ. Its average prediction in the target population matches the
average phase interaction perfectly. -/
