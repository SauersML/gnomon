...
noncomputable def haplotypePhasePredictionError
    (freq_cis interaction_cis interaction_trans interaction_cis_pred interaction_trans_pred : ℝ) : ℝ :=
  freq_cis * (interaction_cis - interaction_cis_pred) ^ 2 +
    (1 - freq_cis) * (interaction_trans - interaction_trans_pred) ^ 2
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis interaction_trans interaction_cis_pred interaction_trans_pred : ℝ) : ℝ :=
  |averagePhaseInteraction freq_cis_target interaction_cis interaction_trans -
