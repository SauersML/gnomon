...
theorem haplotypePhasePredictionError_self (freq_cis interaction_cis interaction_trans : ℝ) :
...
noncomputable def haplotypeTransportBias
    (freq_cis_target interaction_cis_true interaction_trans_true pred_cis pred_trans : ℝ) : ℝ :=
  freq_cis_target * |interaction_cis_true - pred_cis| +
    (1 - freq_cis_target) * |interaction_trans_true - pred_trans|

theorem haplotypeTransportBias_self (freq_cis_target interaction_cis interaction_trans : ℝ) :
...
theorem compound_het_not_captured_by_dosage
  ...
  have h_zero : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans interaction_cis interaction_trans = 0 := haplotypePhasePredictionError_self freq_cis interaction_cis interaction_trans
...
theorem haplotype_pgs_more_portable_for_cis
  ...
  have h_zero : haplotypeTransportBias freq_cis_target interaction_cis interaction_trans interaction_cis interaction_trans = 0 := haplotypeTransportBias_self freq_cis_target interaction_cis interaction_trans
