...
theorem compound_het_not_captured_by_dosage
  ...
  have h_inner : haplotypePhasePredictionError freq_cis interaction_cis interaction_trans = 0 := by unfold haplotypePhasePredictionError; ring_nf
  rw [h_inner]
...
theorem haplotype_pgs_more_portable_for_cis
    ...
    (h_phase_gap : interaction_cis ≠ interaction_trans) :
    haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans < dosageTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans := by
  rw [dosageTransportBias_eq]
  have h_inner : haplotypeTransportBias freq_cis_source freq_cis_target interaction_cis interaction_trans = 0 := by unfold haplotypeTransportBias; simp
  rw [h_inner]
  exact mul_pos
