...
the polygenic-score portability gap; it does not treat drift models of allele-frequency
divergence, allelic heterogeneity or LD tagging, and so does not substantiate anything
