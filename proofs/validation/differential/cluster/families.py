...
FAMILIES = [
    ...
    # =====================================================================
    {
        ...
        "status": "SIMULATED AND GREEN, 0 cells red, positive control fired. "
                  ...
                  "HUDSON_allel matches Conventions.trueHudsonFst to 0.02%-0.7% "
                  "at all eight (p1,p2) cells, and WC_allel agrees with "
                  "HUDSON_allel to six digits. C2: the conversion "
                  "Hudson = 2G/(1+G) proved as trueHudsonFst_eq_of_neiGst holds "
                  ...
                  "C3 REFUTES A LIVE DOCSTRING CLAIM: Conventions.hudsonFst and "
                  ...
                  "`hudsonFst_ne_trueHudsonFst_at_mean_half` at p1 = 9/10, "
                  ...
                  "pre-existing witness `hudsonFst_ne_trueHudsonFst` sits at "
