...
def brier_scope(rng, out):
    ...
    print("  other proper score do NOT.")
    print("")
    print("  SHARPENED BY A LATER MEASUREMENT ON THE REAL RUNS, which supersedes")
    print("  the 'reliability is a free third coordinate' wording above.")
    print("  fam_serial_founder.py established the exact identity")
    print("      Brier = MSE(p, p_true) + E[p_true(1 - p_true)],")
    print("  the cross term vanishing because y | p_true is Bernoulli(p_true),")
    print("  and carried it at R^2 = 0.994 on 400 method-runs by predicting each")
    print("  method's Brier from its own MSE plus the OTHER FOUR methods'")
    print("  residual, fitting nothing. So the correct statement is not that")
    print("  calibration is a vague third coordinate but that")
    print("      AUC IS NOT BRIER'S SECOND COORDINATE AT ALL.")
    print("  MSE(p, p_true) is the second, and E[p_true(1-p_true)] is the third.")
    print("  A proper score adds exactly those two named quantities to what a")
    print("  discrimination metric sees; the scope note should name them rather")
    print("  than gesture at calibration. The reliability decomposition below is")
    print("  the same fact in Murphy coordinates and is kept because it is what")
    print("  makes the AUC-invariance visible.")
    print("  The 94.6% versus 67% split you")
