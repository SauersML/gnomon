...
const NUM_PEOPLE_TO_TEST: [usize; 2] = [5_000, 40_000];
/// The number of score columns to simulate.
const NUM_SCORES_TO_TEST: [usize; 2] = [5, 50];
/// The percentages of the total cohort to score.
const SUBSET_PERCENTAGES: [f32; 3] = [0.05, 0.5, 1.0]; // 5%, 50%, 100%
/// Allele frequencies to test (a sparse and a dense case).
const ALLELE_FREQUENCIES_TO_TEST: [f32; 2] = [0.001, 0.4];
