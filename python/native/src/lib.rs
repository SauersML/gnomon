...
//! gnomon library (`gnomon::score_main`, `gnomon::map`, `gnomon::terms`); no
...
use gnomon::terms::{infer_first_sample_sex, infer_sex_to_tsv};
...
/// The `_gnomon` extension module.
///
/// Every adapter above is a thin call into the gnomon library; this crate
/// owns only the `cdylib` entry point.
#[pymodule]
#[pyo3(name = "_gnomon")]
