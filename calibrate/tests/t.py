#!/usr/bin/env python3
"""
Turn ./gam_model_fit.rds into a human-readable ./gam_model_fit.R,
then round all floats and truncate very long lists of numbers.

Processing Steps:
1. Generate full-precision R code using R's dput().
2. Round all floating-point numbers to 3 decimal places.
3. Find comma-separated lists with >300 numbers and truncate them,
   keeping the first 100 and last 100 elements.

Requirements: R installed with `Rscript` available.
"""
