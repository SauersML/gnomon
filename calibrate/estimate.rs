...
pub fn train_model(
    ...
    if layout.num_penalties == 0 {
        ...
        let final_fit = pirls::fit_model_for_fixed_rho(
            ...
            reml_state.s_full_list(),
            reml_state.balanced_penalty_root(),
            &layout,
            config,
        )?;
...
pub mod internal {
    ...
    impl<'a> RemlState<'a> {
        ...
        pub(super) fn new_with_offset(
            ...
            // Pre-compute the lambda-independent balanced penalty root once per RemlState
        ...
        pub(super) fn s_full_list(&self) -> &Vec<Array2<f64>> {
            &self.s_full_list
        }
