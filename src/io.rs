...
// abstraction boundary. The rest of the application does not know what a "magic number" is,
// how genotypes are packed, or what a byte offset means. This also handles score loading.
