...
def main():
    ...
    child.add_argument("--cpu", type=int, default=96,
                       help="task vCPUs: the 40k simulator run measured 4.4 CPU-hours of binary fits per disease at "
                            "16k training rows on gamfit 0.1.276, about 5.7x that at 300k participants after the "
                            "10k-row first phase of each outer search (MSI, 2026-09-24)")
    ...
    child.add_argument("--timeout-minutes", type=int, default=240)
