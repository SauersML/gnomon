...
task diagnose {
  ...
  command <<<
    ...
    signatures = {
        ...
        "worker_latent_changed": "outcome fit changed the frozen latent score",
        "worker_grid_invalid": "prediction times must be finite",
        "cif_invalid": "invalid cumulative hazard surface",
        "cif_decreasing": "cumulative hazard decreases",
        "cif_grid_error_exceeded": "cif grid refinement differs",
        "auc_no_cases": "auc needs weighted cases and controls",
        "loss_needs_groups": "loss uncertainty needs at least two held-out groups",
