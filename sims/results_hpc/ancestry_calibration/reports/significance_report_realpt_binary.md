...
| distance_bins | grid2d   | phenoA  | z-norm           | AUC                       |        44 |     0.7045 |                0.05384  |            0.03375   |              0.0763   |        1.883e-05 |           5.273e-05 |           1       |               1      |
| distance_bins | grid2d   | phenoA  | PGS + PCs        | Brier score               |        44 |     0.75   |                0.003112 |            0.001941  |              0.004858 |        7.213e-07 |           2.524e-06 |           1       |               1      |
| distance_bins | grid2d   | phenoA  | z-norm           | Brier score               |        44 |     0.9773 |                0.0116   |            0.00846   |              0.01618  |        1.137e-13 |           3.183e-12 |           1       |               1      |
...
| distance_bins | grid2d   | phenoA  | PGS + PCs        | RMSE vs known true risk   |        44 |     0.8182 |                0.007222 |            0.004839  |              0.0104   |        6.667e-07 |           2.489e-06 |           1       |               1      |
...
| distance_bins | serial1d | phenoA  | PGS + PCs        | Brier score               |        40 |     0.775  |                0.004079 |            0.002594  |              0.006509 |        1.222e-06 |           3.801e-06 |           1       |               1      |
| distance_bins | serial1d | phenoA  | z-norm           | Brier score               |        40 |     0.875  |                0.006721 |            0.004889  |              0.009343 |        1.74e-08  |           9.745e-08 |           1       |               1      |
...
| distance_bins | serial1d | phenoA  | z-norm           | MAE vs known true risk    |        40 |     0.7    |                0.01927  |            0.01076   |              0.03197  |        0.0003777 |           0.0007833 |           0.9996  |               1      |
| distance_bins | serial1d | phenoA  | PGS + PCs        | RMSE vs known true risk   |        40 |     0.825  |                0.01166  |            0.007112  |              0.01933  |        2.264e-06 |           6.672e-06 |           1       |               1      |
...
| global_test   | grid2d   | phenoA  | PGS + PCs        | Brier score               |         4 |     1      |                0.003006 |            0.001819  |              0.003764 |        0.0625    |           0.06757   |           1       |               1      |
| global_test   | grid2d   | phenoA  | z-norm           | Brier score               |         4 |     1      |                0.009325 |            0.005098  |              0.01355  |        0.0625    |           0.06757   |           1       |               1      |
...
| global_test   | serial1d | phenoA  | PGS + PCs        | Brier score               |         4 |     1      |                0.004079 |            0.002208  |              0.006908 |        0.0625    |           0.06757   |           1       |               1      |
| global_test   | serial1d | phenoA  | z-norm           | Brier score               |         4 |     1      |                0.006721 |            0.004543  |              0.0089   |        0.0625    |           0.06757   |           1       |               1      |
...
| distance_bins | grid2d   | phenoB  | z-norm           | AUC                       |        44 |     0.75   |                0.04447  |           -0.005058  |             0.07686   |        0.000409  |           0.0007899 |           0.9996  |              1       |
| distance_bins | grid2d   | phenoB  | PGS + PCs        | Brier score               |        44 |     0.7273 |                0.001896 |            0.0009341 |             0.003198  |        0.0002066 |           0.0004627 |           0.9998  |              1       |
| distance_bins | grid2d   | phenoB  | z-norm           | Brier score               |        44 |     0.9091 |                0.01126  |            0.007932  |             0.01562   |        9.607e-12 |           1.345e-10 |           1       |              1       |
| distance_bins | grid2d   | phenoB  | PGS + PCs        | Liability-scale pseudo-R2 |        44 |     0.6591 |                0.04072  |            0.02291   |             0.06716   |        0.0006206 |           0.001121  |           0.9994  |              1       |
| distance_bins | grid2d   | phenoB  | z-norm           | Liability-scale pseudo-R2 |        44 |     0.7727 |                0.1085   |            0.0756    |             0.1483    |        1.045e-07 |           4.502e-07 |           1       |              1       |
| distance_bins | grid2d   | phenoB  | PGS + PCs        | MAE vs known true risk    |        44 |     0.7273 |                0.004222 |            0.0005666 |             0.007242  |        0.0007767 |           0.001359  |           0.9993  |              1       |
| distance_bins | grid2d   | phenoB  | z-norm           | MAE vs known true risk    |        44 |     0.9091 |                0.03265  |            0.02374   |             0.04572   |        4.331e-11 |           4.851e-10 |           1       |              1       |
| distance_bins | grid2d   | phenoB  | PGS + PCs        | RMSE vs known true risk   |        44 |     0.7045 |                0.004979 |            0.001762  |             0.007956  |        0.0005167 |           0.0009645 |           0.9995  |              1       |
...
| distance_bins | serial1d | phenoB  | PGS + PCs        | Brier score               |        40 |     0.7    |                0.001369 |            0.0006989 |             0.002357  |        0.0003992 |           0.0007899 |           0.9996  |              1       |
| distance_bins | serial1d | phenoB  | z-norm           | Brier score               |        40 |     0.725  |                0.005021 |            0.002766  |             0.008581  |        2.539e-05 |           6.771e-05 |           1       |              1       |
...
| distance_bins | serial1d | phenoB  | z-norm           | MAE vs known true risk    |        40 |     0.75   |                0.01401  |            0.006929  |             0.02658   |        0.0003016 |           0.0006497 |           0.9997  |              1       |
...
| global_test   | grid2d   | phenoB  | PGS + PCs        | Brier score               |         4 |     1      |                0.002507 |            0.001037  |             0.003639  |        0.0625    |           0.06757   |           1       |              1       |
| global_test   | grid2d   | phenoB  | z-norm           | Brier score               |         4 |     1      |                0.00857  |            0.004724  |             0.01439   |        0.0625    |           0.06757   |           1       |              1       |
...
| global_test   | serial1d | phenoB  | PGS + PCs        | Brier score               |         4 |     1      |                0.001369 |            0.0004468 |             0.002291  |        0.0625    |           0.06757   |           1       |              1       |
| global_test   | serial1d | phenoB  | z-norm           | Brier score               |         4 |     1      |                0.005021 |            0.001207  |             0.009889  |        0.0625    |           0.06757   |           1       |              1       |
...
| distance_bins | brier                | Brier score               | gamfit   |  44 | 0.124   | 0.13     | 0.05639 | grid2d   | phenoA  |
| distance_bins | brier                | Brier score               | linpc    |  44 | 0.1271  | 0.1315   | 0.05937 | grid2d   | phenoA  |
| distance_bins | brier                | Brier score               | znorm    |  44 | 0.1356  | 0.1318   | 0.0611  | grid2d   | phenoA  |
...
| distance_bins | brier                | Brier score               | gamfit   |  44 | 0.1221  | 0.1272   | 0.05543 | grid2d   | phenoB  |
| distance_bins | brier                | Brier score               | linpc    |  44 | 0.124   | 0.1325   | 0.05678 | grid2d   | phenoB  |
| distance_bins | brier                | Brier score               | znorm    |  44 | 0.1333  | 0.1315   | 0.05973 | grid2d   | phenoB  |
...
| distance_bins | brier                | Brier score               | gamfit   |  40 | 0.1481  | 0.1526   | 0.0551  | serial1d | phenoA  |
| distance_bins | brier                | Brier score               | linpc    |  40 | 0.1522  | 0.1553   | 0.05576 | serial1d | phenoA  |
| distance_bins | brier                | Brier score               | znorm    |  40 | 0.1548  | 0.1505   | 0.05426 | serial1d | phenoA  |
...
| distance_bins | brier                | Brier score               | gamfit   |  40 | 0.1394  | 0.1382   | 0.0549  | serial1d | phenoB  |
| distance_bins | brier                | Brier score               | linpc    |  40 | 0.1408  | 0.1422   | 0.05514 | serial1d | phenoB  |
| distance_bins | brier                | Brier score               | znorm    |  40 | 0.1444  | 0.1376   | 0.05353 | serial1d | phenoB  |
...
| global_test   | brier                | Brier score               | gamfit   |   4 | 0.1306  | 0.1384   | 0.01917 | grid2d   | phenoA  |
| global_test   | brier                | Brier score               | linpc    |   4 | 0.1336  | 0.1421   | 0.02013 | grid2d   | phenoA  |
| global_test   | brier                | Brier score               | znorm    |   4 | 0.1399  | 0.1485   | 0.02329 | grid2d   | phenoA  |
...
| global_test   | brier                | Brier score               | gamfit   |   4 | 0.1271  | 0.1343   | 0.02129 | grid2d   | phenoB  |
| global_test   | brier                | Brier score               | linpc    |   4 | 0.1296  | 0.1379   | 0.02234 | grid2d   | phenoB  |
| global_test   | brier                | Brier score               | znorm    |   4 | 0.1357  | 0.1458   | 0.025   | grid2d   | phenoB  |
...
| global_test   | brier                | Brier score               | gamfit   |   4 | 0.1481  | 0.1534   | 0.02772 | serial1d | phenoA  |
| global_test   | brier                | Brier score               | linpc    |   4 | 0.1522  | 0.1593   | 0.02897 | serial1d | phenoA  |
| global_test   | brier                | Brier score               | znorm    |   4 | 0.1548  | 0.1602   | 0.02931 | serial1d | phenoA  |
...
| global_test   | brier                | Brier score               | gamfit   |   4 | 0.1394  | 0.1492   | 0.03277 | serial1d | phenoB  |
| global_test   | brier                | Brier score               | linpc    |   4 | 0.1408  | 0.1515   | 0.03347 | serial1d | phenoB  |
| global_test   | brier                | Brier score               | znorm    |   4 | 0.1444  | 0.153    | 0.03607 | serial1d | phenoB  |
